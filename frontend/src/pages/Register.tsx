    ...
    <div className="min-h-screen bg-black text-white flex">
      <div className="flex-1 flex items-center justify-center p-8">
        ...
        >
          ...
          <p className="text-zinc-400 mb-8">Start optimizing your ads with AI</p>
      ...
      >
        <div className="max-w-lg">
          <h2 className="text-5xl font-bold mb-6 leading-tight">
            Join the Future
            <br />
            <span className="text-blue-400">Of Advertising</span>
          </h2>
          <p className="text-xl text-zinc-400 leading-relaxed mb-8">
            Get instant access to AI-powered analytics, heatmaps, and A/B testing tools.
          </p>
          <ul className="space-y-4 text-zinc-400">
            ...
            <li className="flex items-center gap-3">
              <div className="w-2 h-2 bg-blue-500 rounded-full" />
              <span>AI attention heatmaps</span>
            </li>
            <li className="flex items-center gap-3">
              <div className="w-2 h-2 bg-blue-500 rounded-full" />
